package a_replit.OOP14BOOKSHELF_236;
...
public class Book {
    ...
    public static Boolean isTitleWord(String word) {
        ...
        List<String> nonWord = Arrays.asList("a" , "an", "the", "and", "but", "for",
                "nor", "or", "so", "yet", "at", "by", "in", "into", "near", "of",
                "on", "to", "than", "via");

        return !nonWord.contains(word.toLowerCase());
