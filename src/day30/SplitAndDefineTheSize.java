...
public class SplitAndDefineTheSize {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("wordsArray1 = " + Arrays.toString(wordsArray1)+" SIZE: "+wordsArray1.length);
        System.out.println("wordsArray2 = " + Arrays.toString(wordsArray2)+" SIZE: "+wordsArray2.length);
        System.out.println("wordsArray3 = " + Arrays.toString(wordsArray3)+" SIZE: "+wordsArray3.length);
        System.out.println("wordsArray4 = " + Arrays.toString(wordsArray4)+" SIZE: "+wordsArray4.length);
        System.out.println("wordsArray5 = " + Arrays.toString(wordsArray5)+" SIZE: "+wordsArray5.length);
        System.out.println("wordsArray6 = " + Arrays.toString(wordsArray6)+" SIZE: "+wordsArray6.length);
